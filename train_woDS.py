...
def parse_args(img_size=512):
    ...
    parser.add_argument('--input_w', default=img_size, type=int,
                        help='image width')
    parser.add_argument('--input_h', default=img_size, type=int,
                        help='image height')
    ...
    # dataset
    parser.add_argument('--dataset', default='ICH' + str(img_size),
                        help='dataset name')
